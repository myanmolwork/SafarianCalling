...
const resumeRecording = document.getElementById('resume_recording_button');
...
const hanhUpChatButton = document.getElementById('finish_chat_call_button');
hanhUpChatButton.addEventListener('click',()=>
{
  webRTCHandler.handleHangUp();
})
