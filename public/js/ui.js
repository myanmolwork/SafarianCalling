...
export const showNoStrangerAvailableDialog = () => {
  const infoDialog = elements.getInfoDialog(
    'No Stranger available', // ✅ fixed typo
...
export const showRecordingPanel = () =>
{
  ...
  //hide start button if it is active
...
export const updateAfterHandUp = (callType) =>
{
  enableDashboard();
